...
1. In Jest, what are the differences between `describe()` and `it()` globals, and what are good uses for them?
    describe is used to group tests for a component or unit which it lends itself well to since it is a nestable function. It is the actual test method we use to test our assertions

1. What is the point of `Test Driven Development`? What do you think about this approach?
To make it so that our units, or apps while being developed are as user-proof as possible. This is more time consuming to start but holds massive value when it comes to refactoring, debugging or generally working on the code after deployment as to not break user experience in advertently and not realize it

1. Mention three types of automated tests.
I/O testing, Unit Testing, UI regression testing, Integration testing, and production logging
